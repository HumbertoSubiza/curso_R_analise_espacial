...
As duas funcoes executadas anteriormente sao opcionais, no sentido de que sao necessarias como entrada para todas as funcoes que seguem e serao chamadas automaticamente caso nao ter sido executadas previamente.
